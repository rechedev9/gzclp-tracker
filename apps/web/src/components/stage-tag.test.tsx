...
describe('StageTag', () => {
  ...
  it('should show "Precaución" label for stage 1', () => {
    ...
    expect(tag).toHaveAttribute('title', 'Stage 2: Precaución');
  });
  ...
  it('should show "Reinicio próximo fallo" label for stage 2', () => {
    ...
    expect(tag).toHaveAttribute('title', 'Stage 3: Reinicio próximo fallo');
  });
  ...
  it('should clamp stages above 2 to stage 2', () => {
    ...
    expect(tag).toHaveAttribute('title', 'Stage 6: Reinicio próximo fallo');
  });
});
