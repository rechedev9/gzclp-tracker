  ...
  return (
    <>
      ...
      <div className="max-w-[1300px] mx-auto px-5 pb-20">
        ...
        {startWeights && (
          <div className="flex gap-8 items-start max-[1024px]:flex-col">
            {/* Left column: Program */}
              ...
              <details className="bg-[var(--bg-card)] border border-[var(--border-color)] mb-6 overflow-hidden">
                ...
                <div className="px-5 pb-5 border-t border-[var(--border-light)]">
                  <ul className="mt-3 ml-5 text-[13px] leading-8 text-[var(--text-info)] list-disc">
                    ...
                    <li>
                      <strong>T2 Stage 3 Fail</strong> — Adds 15 kg to original weight, restarts at
                      3&times;10
                    </li>
                    <li>
                    ...
                    <li>
                      <strong>Stage Colors</strong> — S1 (black) = normal, S2 (orange) = caution, S3
                      (red) = reset next fail
                    </li>
                    <li>
                      <strong>Undo</strong> — Click any badge to undo, or use the Undo button in the
                      toolbar
                    </li>
                    <li>
            ...
            <div className="w-[400px] max-[1024px]:w-full shrink-0 sticky top-[96px]">
              <h2 className="text-xs font-bold uppercase tracking-widest text-[var(--text-muted)] mb-4 pb-2 border-b border-[var(--border-color)]">
                Stats &amp; Charts
              </h2>
              <ErrorBoundary
                fallback={({ reset }) => (
